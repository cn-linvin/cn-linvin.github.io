...
video.txt：
...\userdata\0123456789\730\local\cfg

CSGO->属性：
通用->均取消勾选->启动选项->+exec 1 -tickrate 128
本地文件->浏览->csgo.exe->属性->兼容性->勾选禁用全屏优化->更改高DPI设置->勾选替代高DPI缩放行为(应用程序)->验证游戏文件的完整性
控制器->禁用Steam输入

Steam->设置：
下载->清除下载缓存
网页浏览器->删除网页浏览器缓存->删除所有浏览器COOKIE
